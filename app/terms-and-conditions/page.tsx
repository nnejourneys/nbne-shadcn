      ...
      <Bounded width="marginxy">
        <div className="max-w-4xl">
          ...
          <P>
            ...
            use of North by Northeast Journeys&apos;s Website, located at
            https://nnejourneys.com/. By accessing this website we assume you
            accept these terms and conditions. Do not continue to use
            https://nnejourneys.com/ if you do not agree to take all of the
          ...
          <P>
            We employ the use of cookies. By accessing https://nnejourneys.com/,
            you agreed to use cookies in agreement with the North by Northeast
            Journeys&apos;s Privacy Policy.
          </P>
          <P>
          ...
          <P>
            Unless otherwise stated, North by Northeast Journeys and/or its
            licensors own the intellectual property rights for all material on
            https://nnejourneys.com/. All intellectual property rights are
            reserved. You may access this from https://nnejourneys.com/ for your
            own personal use subjected to restrictions set in these terms and
            conditions.
          </P>
          <P>You must not:</P>
          <ul className="list-disc ml-5 my-3 space-y-2">
            <li>Republish material from https://nnejourneys.com/</li>
            <li>
              Sell, rent or sub-license material from https://nnejourneys.com/
            </li>
            <li>
              Reproduce, duplicate or copy material from
              https://nnejourneys.com/
            </li>
            <li>Redistribute content from https://nnejourneys.com/</li>
          </ul>
          <P>
            Parts of this website offer an opportunity for users to post and
            exchange opinions and information in certain areas of the website.
            North by Northeast Journeys does not filter, edit, publish or review
            Comments prior to their presence on the website. Comments do not
            reflect the views and opinions of North by Northeast Journeys, its
            ...
            permitted by applicable laws, North by Northeast Journeys shall not
          ...
          <P>
            North by Northeast Journeys reserves the right to monitor all
          ...
          <P>
            You hereby grant North by Northeast Journeys a non-exclusive license
          ...
          <ul className="list-alpha ml-5 my-3 space-y-2">
          ...
          <ul className="list-alpha ml-5 my-3 space-y-2">
            ...
            <li>
              ...
              the absence of North by Northeast Journeys; and
            </li>
          ...
          <P>
            ...
            sending an e-mail to North by Northeast Journeys. Please include
