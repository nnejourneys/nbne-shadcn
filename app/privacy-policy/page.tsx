      ...
      <Bounded width="marginxy">
        ...
        <ul className="list-disc ml-5 my-3 space-y-2">
          ...
          <li>
            ...
            refers to North by Northeast Journeys, #222, Mansiri House.
          </li>
          <li>
          ...
          <li>Country refers to: AS, India</li>
          <li>
          ...
          <li>
            Website refers to North by Northeast Journeys, accessible from
        ...
        <ul className="list-disc ml-5 my-3 space-y-2">
          ...
          <li>
            ...
            <Button variant="link">
              <a href="https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_" target="_blank">
        ...
        <ul className="list-disc ml-5 my-3 space-y-2">
          <li>By email: nnejourneys@gmail.com</li>
        </ul>
      </Bounded>
    </>
  );
